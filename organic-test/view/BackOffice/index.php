...
<html lang="en">
  <head>
    ...
    <!-- inject:css -->
    <link rel="stylesheet" href="/view/BackOffice/assets/css/vertical-light-layout/style.css">
    <!-- endinject -->
    <!-- Layout styles -->
  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <img src="assets/images/logoShef.png" 
              alt="logo" 
              class="logo-dark" 
              style="width: 70px; height: 70px; border-radius: 50%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); object-fit: cover;" />

          <img src="assets/images/logo-light.svg" alt="logo-light" class="logo-light" style="width: 150px; height: auto; border-radius: 10px; display: none;" />
        </a>
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex">Welcome To Our Shop</h5>
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ms-2" src="assets/images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal"> Bouallegui Souhaib </span></a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="assets/images/faces/face8.jpg" alt="Profile image">
                  <p class="mb-1 mt-3">Bouallegui Souhaib</p>
              ...
              <div class="col-md-12 grid-margin">
                <div class="card">
                  ...
                  <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <a href="adddproduct.php" class="btn px-0"> 
                        <i class="icon-user me-2"></i> Add Product
                      </a>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <a href="ProductList.php" class="btn px-0">
                        <i class="icon-docs me-2"></i> List Products
                      </a>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <a href="Purchases.php" class="btn px-0">
                        <i class="icon-folder me-2"></i> List Purchases
                      </a>
                    </div>
                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                      <a href="createInvoice.php" class="btn px-0">
                        <i class="icon-book-open me-2"></i> Create Invoice
                      </a>
                    </div>
