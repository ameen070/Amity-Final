...
<body>
  ...
  <div class="container-fluid">
    <div class="row py-3 border-bottom">
      ...
      <div class="col-lg-4">
        <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
          ...
          <div class="col-md-4 d-none d-md-block">
            <select class="custom-select border-0 bg-transparent">
          ...
          <!-- Cart Icon -->
          <!-- Cart Icon with Text and Additional Icon -->
              <li class="nav-item">
                <a href="addtocart.php" class="nav-link d-flex align-items-center">
                <i class="fas fa-shopping-basket"></i>


                  <span class="ms-2">Cart</span> <!-- Text next to the icon -->
                  <svg width="16" height="16" class="ms-2"><use xlink:href="#arrow-right"></use></svg> <!-- Additional icon -->
                </a>
              </li>
    ...
    <section class="pb-5">
        ...
        <div class="row">
                <div class="col-md-12">
                    <div class="section-header d-flex flex-wrap justify-content-between align-items-center my-4">
                        <h2 class="section-title">Fruits & Veggies</h2>
                        <div class="d-flex align-items-center">
                            <!-- Search Field -->
                            <form action="search.php" method="GET" class="d-flex align-items-center me-3" style="margin-right: 20px;">
                                <input type="text" name="query" class="form-control rounded-1" placeholder="Search for a product..." style="width: 250px;">
                                <button type="submit" class="btn btn-primary ms-2">Search</button>
                            </form>
                            <!-- View All Button -->
                            <a href="allproducts.php" class="btn btn-primary rounded-1">View All</a>
                        </div>
                    </div>
                </div>
            </div>
